...
public class MedicineController extends BaseController{
	...
	public ResponseEntity<?> saveMedicine(@RequestBody MedicineDTO request) {
		try {
	...
	public ResponseEntity<?> saveMedicineSheep(@RequestBody MedicineDiseaseOfSheepDTO request) {
		try {
	...
	public ResponseEntity<?> getAllValidMedicine() {
		try {
