...
function Steps_li_2_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r278); const ctx_r279 = ɵngcc0.ɵɵnextContext(); const item_r272 = ctx_r279.$implicit; const i_r273 = ctx_r279.index; const ctx_r277 = ɵngcc0.ɵɵnextContext(); return ctx_r277.itemClick($event, item_r272, i_r273); })("keydown.enter", function Steps_li_2_a_2_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r278); const ctx_r281 = ɵngcc0.ɵɵnextContext(); const item_r272 = ctx_r281.$implicit; const i_r273 = ctx_r281.index; const ctx_r280 = ɵngcc0.ɵɵnextContext(); return ctx_r280.itemClick($event, item_r272, i_r273); });
    ...
    const item_r272 = ctx_r282.$implicit;
    const i_r273 = ctx_r282.index;
    const ctx_r275 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵattribute("href", item_r272.url, ɵngcc0.ɵɵsanitizeUrl)("target", item_r272.target)("id", item_r272.id)("tabindex", item_r272.disabled || i_r273 !== ctx_r275.activeIndex && ctx_r275.readonly ? null : item_r272.tabindex ? item_r272.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r273 + 1);
    ɵngcc0.ɵɵadvance(2);
...
function Steps_li_2_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r284); const ctx_r285 = ɵngcc0.ɵɵnextContext(); const item_r272 = ctx_r285.$implicit; const i_r273 = ctx_r285.index; const ctx_r283 = ɵngcc0.ɵɵnextContext(); return ctx_r283.itemClick($event, item_r272, i_r273); })("keydown.enter", function Steps_li_2_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r284); const ctx_r287 = ɵngcc0.ɵɵnextContext(); const item_r272 = ctx_r287.$implicit; const i_r273 = ctx_r287.index; const ctx_r286 = ɵngcc0.ɵɵnextContext(); return ctx_r286.itemClick($event, item_r272, i_r273); });
    ɵngcc0.ɵɵelementStart(1, "span", 8);
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(3, "span", 9);
    ...
    const item_r272 = ctx_r288.$implicit;
    const i_r273 = ctx_r288.index;
    const ctx_r276 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("routerLink", item_r272.routerLink)("queryParams", item_r272.queryParams)("routerLinkActive", "ui-state-active")("routerLinkActiveOptions", item_r272.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(9, _c0));
    ɵngcc0.ɵɵattribute("target", item_r272.target)("id", item_r272.id)("tabindex", item_r272.disabled || i_r273 !== ctx_r276.activeIndex && ctx_r276.readonly ? null : item_r272.tabindex ? item_r272.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r273 + 1);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(item_r272.label);
...
function Steps_li_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassMap(item_r272.styleClass);
    ɵngcc0.ɵɵproperty("ngStyle", item_r272.style)("ngClass", ɵngcc0.ɵɵpureFunction4(8, _c1, i_r273 === ctx_r271.activeIndex, i_r273 !== ctx_r271.activeIndex, i_r273 < ctx_r271.activeIndex, item_r272.disabled || i_r273 !== ctx_r271.activeIndex && ctx_r271.readonly));
    ɵngcc0.ɵɵattribute("aria-selected", i_r273 === ctx_r271.activeIndex)("aria-expanded", i_r273 === ctx_r271.activeIndex);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !item_r272.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r272.routerLink);
} }
