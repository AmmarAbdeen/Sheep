...
function VirtualScroller_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r422 = ctx.$implicit;
    const i_r423 = ctx.index;
    const c_r424 = ctx.count;
    const f_r425 = ctx.first;
    const l_r426 = ctx.last;
    const e_r427 = ctx.even;
    const o_r428 = ctx.odd;
    const ctx_r420 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(3, _c1, ctx_r420.itemSize + "px"));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", item_r422 ? ctx_r420.itemTemplate : ctx_r420.loadingItemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction7(5, _c2, item_r422, i_r423, c_r424, f_r425, l_r426, e_r427, o_r428));
} }
