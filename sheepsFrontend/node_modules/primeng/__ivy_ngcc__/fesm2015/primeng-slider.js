...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r246.handleValues[0] + "%", ctx_r246.handleValues[1] - ctx_r246.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r247.handleValues[0] + "%", ctx_r247.handleValues[1] - ctx_r247.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r248.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r249.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r255); const ctx_r254 = ɵngcc0.ɵɵnextContext(); return ctx_r254.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r255); const ctx_r256 = ɵngcc0.ɵɵnextContext(); return ctx_r256.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r255); const ctx_r257 = ɵngcc0.ɵɵnextContext(); return ctx_r257.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r255); const ctx_r258 = ɵngcc0.ɵɵnextContext(); return ctx_r258.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r255); const ctx_r259 = ɵngcc0.ɵɵnextContext(); return ctx_r259.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r250 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r250.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r250.orientation == "horizontal" ? ctx_r250.handleValue + "%" : null, ctx_r250.orientation == "vertical" ? ctx_r250.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r250.tabindex)("aria-valuemin", ctx_r250.min)("aria-valuenow", ctx_r250.value)("aria-valuemax", ctx_r250.max)("aria-labelledby", ctx_r250.ariaLabelledBy);
} }
...
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r262); const ctx_r261 = ɵngcc0.ɵɵnextContext(); return ctx_r261.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r262); const ctx_r263 = ɵngcc0.ɵɵnextContext(); return ctx_r263.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r262); const ctx_r264 = ɵngcc0.ɵɵnextContext(); return ctx_r264.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r262); const ctx_r265 = ɵngcc0.ɵɵnextContext(); return ctx_r265.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r262); const ctx_r266 = ɵngcc0.ɵɵnextContext(); return ctx_r266.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r251 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r251.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r251.rangeStartLeft, ctx_r251.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r251.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r251.tabindex)("aria-valuemin", ctx_r251.min)("aria-valuenow", ctx_r251.value ? ctx_r251.value[0] : null)("aria-valuemax", ctx_r251.max)("aria-labelledby", ctx_r251.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r269 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 11);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r269); const ctx_r268 = ɵngcc0.ɵɵnextContext(); return ctx_r268.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r269); const ctx_r270 = ɵngcc0.ɵɵnextContext(); return ctx_r270.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r269); const ctx_r271 = ɵngcc0.ɵɵnextContext(); return ctx_r271.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r269); const ctx_r272 = ɵngcc0.ɵɵnextContext(); return ctx_r272.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r269); const ctx_r273 = ɵngcc0.ɵɵnextContext(); return ctx_r273.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r252 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r252.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r252.rangeEndLeft, ctx_r252.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r252.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r252.tabindex)("aria-valuemin", ctx_r252.min)("aria-valuenow", ctx_r252.value ? ctx_r252.value[1] : null)("aria-valuemax", ctx_r252.max)("aria-labelledby", ctx_r252.ariaLabelledBy);
} }
