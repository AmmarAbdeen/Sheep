...
function SelectButton_div_1_ng_container_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r254 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵclassMap(option_r254.icon);
...
function SelectButton_div_1_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r254 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", option_r254.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(option_r254.label || "ui-btn");
} }
...
function SelectButton_div_1_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r254 = ctx_r264.$implicit;
    const i_r255 = ctx_r264.index;
    const ctx_r259 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r259.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c1, option_r254, i_r255));
} }
...
function SelectButton_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function SelectButton_div_1_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r266); const option_r254 = ctx.$implicit; const i_r255 = ctx.index; const ctx_r265 = ɵngcc0.ɵɵnextContext(); return ctx_r265.onItemClick($event, option_r254, i_r255); })("keydown.enter", function SelectButton_div_1_Template_div_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r266); const option_r254 = ctx.$implicit; const i_r255 = ctx.index; const ctx_r267 = ɵngcc0.ɵɵnextContext(); return ctx_r267.onItemClick($event, option_r254, i_r255); })("focus", function SelectButton_div_1_Template_div_focus_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r266); const ctx_r268 = ɵngcc0.ɵɵnextContext(); return ctx_r268.onFocus($event); })("blur", function SelectButton_div_1_Template_div_blur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r266); const ctx_r269 = ɵngcc0.ɵɵnextContext(); return ctx_r269.onBlur($event); });
    ...
    const option_r254 = ctx.$implicit;
    const _r256 = ɵngcc0.ɵɵreference(1);
    const _r258 = ɵngcc0.ɵɵreference(4);
    const ctx_r253 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMapInterpolate1("ui-button ui-widget ui-state-default ui-button-text-only ", option_r254.styleClass, "");
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction5(11, _c2, ctx_r253.isSelected(option_r254), ctx_r253.disabled || option_r254.disabled, _r256 == ctx_r253.focusedItem, option_r254.icon != null, option_r254.icon && !option_r254.label));
    ɵngcc0.ɵɵattribute("aria-pressed", ctx_r253.isSelected(option_r254))("title", option_r254.title)("aria-label", option_r254.label)("tabindex", ctx_r253.tabindex)("aria-labelledby", ctx_r253.ariaLabelledBy);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r253.itemTemplate)("ngIfElse", _r258);
} }
