...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r327); const ctx_r326 = ɵngcc0.ɵɵnextContext(); return ctx_r326.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r327); const ctx_r328 = ɵngcc0.ɵɵnextContext(); return ctx_r328.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
function ToastItem_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(3, _c1, ctx_r324.message.severity == "info", ctx_r324.message.severity == "warn", ctx_r324.message.severity == "error", ctx_r324.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r324.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r324.message.detail);
} }
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r334); const ctx_r333 = ɵngcc0.ɵɵnextContext(); return ctx_r333.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r334); const ctx_r335 = ɵngcc0.ɵɵnextContext(); return ctx_r335.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const msg_r331 = ctx.$implicit;
    const i_r332 = ctx.index;
    const ctx_r330 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r331)("index", i_r332)("template", ctx_r330.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r330.showTransformOptions)("hideTransformOptions", ctx_r330.hideTransformOptions)("showTransitionOptions", ctx_r330.showTransitionOptions)("hideTransitionOptions", ctx_r330.hideTransitionOptions);
} }
