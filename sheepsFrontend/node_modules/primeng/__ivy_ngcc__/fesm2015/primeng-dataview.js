...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r301.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r308); const ctx_r307 = ɵngcc0.ɵɵnextContext(); return ctx_r307.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r302 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r302.rows)("first", ctx_r302.first)("totalRecords", ctx_r302.totalRecords)("pageLinkSize", ctx_r302.pageLinks)("alwaysShow", ctx_r302.alwaysShowPaginator)("rowsPerPageOptions", ctx_r302.rowsPerPageOptions)("dropdownAppendTo", ctx_r302.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r302.paginatorDropdownScrollHeight)("templateLeft", ctx_r302.paginatorLeftTemplate)("templateRight", ctx_r302.paginatorRightTemplate)("currentPageReportTemplate", ctx_r302.currentPageReportTemplate)("showCurrentPageReport", ctx_r302.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    const rowData_r309 = ctx.$implicit;
    const rowIndex_r310 = ctx.index;
    const ctx_r303 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r303.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r309, rowIndex_r310));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r304.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r313); const ctx_r312 = ɵngcc0.ɵɵnextContext(); return ctx_r312.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r305 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r305.rows)("first", ctx_r305.first)("totalRecords", ctx_r305.totalRecords)("pageLinkSize", ctx_r305.pageLinks)("alwaysShow", ctx_r305.alwaysShowPaginator)("rowsPerPageOptions", ctx_r305.rowsPerPageOptions)("dropdownAppendTo", ctx_r305.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r305.paginatorDropdownScrollHeight)("templateLeft", ctx_r305.paginatorLeftTemplate)("templateRight", ctx_r305.paginatorRightTemplate)("currentPageReportTemplate", ctx_r305.currentPageReportTemplate)("showCurrentPageReport", ctx_r305.showCurrentPageReport);
} }
